...
| Radiator | Thermal map | Heat rejection or UA versus coolant flow, air flow and inlet temperatures | Exact radiator supplier test report |
| Radiator | Hydraulic map | Coolant pressure drop in kPa versus L/min and temperature | Exact radiator supplier curve |
...
| Hydraulics | Motor, PDU and installed-component pressure losses | kPa versus L/min | Depends on the exact installed passages and fittings |
...
| Propulsion operating flow | Full active pump curve and complete component pressure-drop curves |
