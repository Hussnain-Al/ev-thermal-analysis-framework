...
Battery specification values are held in the battery configuration with the
source PDF recorded in the provenance manifest. No compressor data are active.
